...
# === Load data ===
df = pd.read_csv("data/nvda_features_24-25.csv")
...
df.to_csv("data/nvda_backtest_dual_layer.csv", index=False)
...
plt.title("NVDA Dual-Layer Strategy: Macro Regime + Tactical Risk Control")
plt.xlabel("Date")
plt.ylabel("Equity ($)")
plt.legend()
plt.show()